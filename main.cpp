...
void solveAlgoritm(string algo, int *a, int n, double &time, long long &cc, string para)
{
    ...
    case 1:
        ...
        if (mode_para == 2) SelectionSort_compare(a, n, cc);
            break;
    case 2:
        if (mode_para == 3 || mode_para == 1)
        {
        ...
        if (mode_para == 2) InsertionSort_compare(a, n, cc);
            break;
    case 3:
        if (mode_para == 3 || mode_para == 1)
        {
